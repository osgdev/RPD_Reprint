...
public class SubmitJobController {
    ...
    public void initialize() {
        ...
        menuAdmin.setVisible(Session.getIsAdmin());
    ...
    public void cardAction() {
        ...
        if (chboxApp.getSelectionModel().isEmpty()) {
            ...
            String selectedCardType = chboxCardType.getSelectionModel().getSelectedItem().toString().equalsIgnoreCase("ALL") ? "" : chboxCardType.getSelectionModel().getSelectedItem().toString();
        ...
        if (!isInputValid(workflowId) && !isWholeBatchReprint(workflowId)) {
            ...
            new Thread(() -> {
                try {
                    ...
                    fileHandler.setDatFileContent("");
                    fileHandler.setEotFileContent("WID=" + workflowId + "\nLOCATION=" + selectedSite + "\nUSER=" + Session.getUserName());
                    fileHandler.submit();
